...
# Vary proliferation rates (0.004T, 0.008T, 0.016T, 0.032T, 0.064T, infinity)
# Default: 0.016T = 80,000
totT = 5000000
prolif_rates = [0.008, 0.012, 0.016, 0.032, 0.064, 0]
...
for sim_id in sim_subset:
    ...
    for p_rate in prolif_rates:
    
        task_id += 1
        
        cell_population_prop = [pop_ratio, 1.0 - pop_ratio]
        ...
        save_data['prolif_time'] = p_rate * totT
